    ...
    >
      ...
      >
        ...
        >
          <div className="orange-text">
            ...
            <h4>
              <b>
                Weather forecasts, nowcasts and history in fast <br /> and
                elegant way
              </b>
            </h4>
          </div>
      ...
      >
        <p class="red-text">
          ...
          <a href=""> subscribe to our service</a>, you can join us to help with{" "}
          <b>donation of just of £20</b> .
          <br />
          Openweather <b>will add £40</b> to each donation and send it to
     ...
     <div class="gray-container">
         <form>
           ...
           <input id="search-city-input" type="text" placeholder="Search City" name="" />
